export const operators = {
  ...
  exponent: {
    symbol: '<span class="font-extrabold">a<sup>b</sup></span>',
    render: (a, b) => {
      return `<span class="font-extrabold">${a}<sup>${b}</sup></span>`
    }
  },
  root: {
    symbol: '<span class="font-extrabold"><sup>b</sup>&#8730;a</span>',
    render: (a, b) => {
      return `<span class="font-extrabold"><sup>${b}</sup>&#8730;${a}</span>`
    }
  },
}
