  ...
  <div class="flex flex-column justify-start">
    <div @click="restart()" class="cursor-pointer flex group">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" 
        class="w-6 h-6 stroke-0 fill-accent-error"
      >
      ...
      <span class="text-accent-error font-bold transition-all opacity-0 duration-500 group-hover:translate-x-4 group-hover:opacity-100">Restart</span>
    </div>
  </div>
</template>
