    ...
    <div class="container px-6 py-4 mx-auto">
      <div class="lg:flex lg:items-center lg:justify-between">
        <div class="flex items-center justify-between">
          <a href="#">
            <img class="w-auto h-6 sm:h-7" src="https://img.logoipsum.com/289.svg" alt="">
          </a>
        ...
        <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']"
          ...
          <div class="flex flex-col -mx-6 lg:flex-row lg:items-center lg:mx-8">
            <NuxtLink to="/"
              :class="route.path == '/' ? 'text-blue-700' : 'text-gray-700'"
              class="px-3 py-2 mx-3 mt-2 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Dashboard</NuxtLink>
